...
public class BloodArsenalResearchItem extends ResearchItem {
    ...
    public BloodArsenalResearchItem(String par1, String x, AspectList tags, int y, int z, int par5,
    ...
    public BloodArsenalResearchItem(String par1, String x, String mod, AspectList tags, int y, int z, int par5,
            ResourceLocation icon) {
        super(par1, x, tags, y, z, par5, icon);
        this.inter = mod;
    }
    ...
    public String getText() {
        return BloodArsenalConfig.researchTag
                ? (this.inter == null
                        ? "[BA] " + StatCollector.translateToLocal("blood_arsenal.research_text." + this.key)
                        : "[BA] " + this.inter
                                + " "
                                + StatCollector.translateToLocal("blood_arsenal.research_text." + this.key))
                : StatCollector.translateToLocal("blood_arsenal.research_text." + this.key);
    }
}
