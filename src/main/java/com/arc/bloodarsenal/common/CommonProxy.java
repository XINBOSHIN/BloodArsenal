...
public class CommonProxy {
    ...
    public static void registerEntityTrackers() {
        ...
        EntityRegistry
                .registerModEntity(EntityBloodTNT.class, "bloodTNT", entityID, BloodArsenal.instance, 64, 100, true);
        // EntityRegistry.registerModEntity(EntityBloodHound.class, "BloodHound", 3, BloodArsenal.instance, 96,
        // 3, true);
    }
