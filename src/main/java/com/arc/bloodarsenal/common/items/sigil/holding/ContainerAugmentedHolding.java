...
public class ContainerAugmentedHolding extends Container {
    ...
    public ContainerAugmentedHolding(EntityPlayer player, InventoryAugmentedHolding inventoryHolding) {
        ...
        for (int columnIndex = 0; columnIndex < inventoryColumns; ++columnIndex) {
            this.addSlotToContainer(
                    new SlotHolding(this, inventoryHolding, player, columnIndex, 8 + columnIndex * 18, 15));
        }
    ...
    private class SlotHolding extends Slot {
        ...
        public SlotHolding(ContainerAugmentedHolding containerHolding, IInventory inventory, EntityPlayer player,
