                ...
                for (int yy = -3; yy <= 3; yy++) {
                    for (int zz = -3; zz <= 3; zz++) {
                        world.scheduleBlockUpdate(
                                ...
                                lasty + yy,
                                lastz + zz,
                                world.getBlock(lastx + xx, lasty + yy, lastz + zz),
        ...
        for (int xx = -2; xx <= 2; xx++) {
            for (int yy = 2; yy >= -2; yy--) {
                for (int zz = -2; zz <= 2; zz++) {
                    ...
                    if ((world.getBlock(lastx + xx, lasty + yy, lastz + zz) == block)
                            && (isWood(world, lastx + xx, lasty + yy, lastz + zz))
                            && (block.getBlockHardness(world, lastx + xx, lasty + yy, lastz + zz) >= 0.0F)) {
