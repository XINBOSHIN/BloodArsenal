...
public class ElementalLifeImbuedArmor extends ItemArmor implements ISpecialArmor, IFillable {
    ...
    public boolean hasArmorSetItem(EntityPlayer player, int i) {
        ...
        switch (i) {
            case 0:
                return stack.getItem() == ModItems.life_imbued_helmet_water;
            case 1:
                return stack.getItem() == ModItems.life_imbued_chestplate_fire;
            case 2:
                return stack.getItem() == ModItems.life_imbued_leggings_earth;
            case 3:
                return stack.getItem() == ModItems.life_imbued_boots_air;
        }
